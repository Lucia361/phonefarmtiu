...
public class fHDThamGiaNhomTuKhoa : Form
{
  ...
  public fHDThamGiaNhomTuKhoa(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDThamGiaNhomTuKhoa.bool_0 = false;
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDThamGiaNhomTuKhoa");
  ...
  private void fHDThamGiaNhomTuKhoa_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.txtTuKhoa.Text = this.jobject_0["txtTuKhoa"].ToString();
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    if (string_1 == "")
      ...
      GClass14.smethod_0((object) GClass35.smethod_0("Vui lòng nhập danh sách từ khóa!"), 3);
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDThamGiaNhomTuKhoa.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void txtTuKhoa_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      this.lblStatus.Text = string.Format(GClass35.smethod_0("Danh sách từ khóa ({0}):"), (object) stringList.Count.ToString());
    }
    catch
    {
    }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDThamGiaNhomTuKhoa));
    ...
    this.panel1.Size = new Size(713, 375);
    ...
    this.label9.Location = new Point(3, 218);
    ...
    this.ckbTuDongTraLoiCauHoi.Location = new Point(349, 51);
    ...
    this.txtTuKhoa.Location = new Point(31, 159);
    this.txtTuKhoa.Name = "txtTuKhoa";
    this.txtTuKhoa.Size = new Size(295, 136);
    ...
    this.btnCancel.Location = new Point(354, 329);
    ...
    this.btnAdd.Location = new Point(247, 329);
    ...
    this.ClientSize = new Size(713, 375);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDThamGiaNhomTuKhoa);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDThamGiaNhomTuKhoa_Load);
