...
public class fHDKetBanTepUidNew : Form
{
  ...
  public fHDKetBanTepUidNew(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDKetBanTepUidNew.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDKetBanTepUidNew").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanTepUidNew', 'Kết bạn theo tệp Uid v2');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDKetBanTepUidNew");
  ...
  private void fHDKetBanTepUidNew_Load(object sender, EventArgs e)
  {
    try
    {
      this.txtLink.Text = this.gclass22_0.method_1("txtLink");
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      gclass22.method_6("txtLink", (object) this.txtLink.Text);
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDKetBanTepUidNew.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void txtLink_TextChanged(object sender, EventArgs e)
  {
    try
    {
      List<string> stringList = GClass19.smethod_39(((IEnumerable<string>) this.txtLink.Lines).ToList<string>());
      this.label5.Text = string.Format(GClass35.smethod_0("Danh sách Link bài viết ({0}):"), (object) stringList.Count.ToString());
    }
    catch
    {
    }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDKetBanTepUidNew));
    ...
    this.panel1.Controls.Add((Control) this.txtLink);
    ...
    this.panel1.Size = new Size(362, 417);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.txtLink.Location = new Point(31, 160);
    this.txtLink.Name = "txtLink";
    this.txtLink.Size = new Size(297, 189);
    ...
    this.label10.Location = new Point(29, 352);
    this.label10.Name = "label10";
    this.label10.Size = new Size(96, 16);
    this.label10.TabIndex = 58;
    this.label10.Text = "(Mỗi ID 1 dòng)";
    this.nudDelayTo.Location = new Point(231, 109);
    ...
    this.nudDelayFrom.Location = new Point(134, 109);
    ...
    this.label3.Location = new Point(196, 80);
    ...
    this.label8.Location = new Point(27, 80);
    ...
    this.label5.Location = new Point(27, 141);
    this.label5.Name = "label5";
    this.label5.Size = new Size(163, 16);
    ...
    this.btnCancel.Location = new Point(189, 373);
    ...
    this.btnAdd.Location = new Point(82, 373);
    ...
    this.ClientSize = new Size(362, 417);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDKetBanTepUidNew);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDKetBanTepUidNew_Load);
