...
public class fHDXemWatch : Form
{
  ...
  private NumericUpDown nudPercentComment;
  private Label label20;
  private Label label19;
  private NumericUpDown nudPercentShare;
  ...
  private void fHDXemWatch_Load(object sender, EventArgs e)
  {
    try
    {
      this.nudTimeFrom.Value = (Decimal) this.gclass22_0.method_3("nudTimeFrom", 30);
      ...
      this.nudPercentLike.Value = (Decimal) this.gclass22_0.method_3("nudPercentLike", 50);
      this.nudPercentShare.Value = (Decimal) this.gclass22_0.method_3("nudPercentShare", 50);
      this.nudPercentComment.Value = (Decimal) this.gclass22_0.method_3("nudPercentComment", 50);
    }
    catch
    {
    }
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      gclass22.method_6("nudPercentLike", (object) this.nudPercentLike.Value);
      gclass22.method_6("nudPercentShare", (object) this.nudPercentShare.Value);
      gclass22.method_6("nudPercentComment", (object) this.nudPercentComment.Value);
  ...
  private void InitializeComponent()
  {
    ...
    this.nudPercentComment = new NumericUpDown();
    ...
    this.nudPercentShare = new NumericUpDown();
    ...
    this.nudPercentLike = new NumericUpDown();
    ...
    this.bunifuCustomLabel1.Size = new Size(356, 31);
    ...
    this.pnlHeader.Size = new Size(356, 31);
    ...
    this.button1.Location = new Point(325, 1);
    ...
    this.panel1.Size = new Size(359, 424);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.nudTimeTo.Location = new Point(219, 78);
    ...
    this.nudTimeFrom.TabIndex = 45;
    this.label3.Location = new Point(190, 80);
    ...
    this.label4.Location = new Point(274, 80);
    ...
    this.label2.Text = "Thời gian xem:";
    this.plCountComment.Controls.Add((Control) this.nudPercentComment);
    this.plCountComment.Controls.Add((Control) this.nudCountCommentFrom);
    this.plCountComment.Controls.Add((Control) this.label20);
    this.plCountComment.Controls.Add((Control) this.label13);
    this.plCountComment.Controls.Add((Control) this.label14);
    this.plCountComment.Controls.Add((Control) this.label19);
    this.plCountComment.Controls.Add((Control) this.nudCountCommentTo);
    this.plCountComment.Location = new Point(132, 166);
    this.plCountComment.Name = "plCountComment";
    this.plCountComment.Size = new Size(186, 25);
    this.plCountComment.TabIndex = 44;
    this.nudPercentComment.Location = new Point(237, 1);
    this.nudPercentComment.Name = "nudPercentComment";
    this.nudPercentComment.Size = new Size(44, 23);
    this.nudPercentComment.TabIndex = 38;
    this.nudPercentComment.Value = new Decimal(new int[4]
    {
      100,
      0,
      0,
    ...
    this.label20.Location = new Point(283, 3);
    this.label20.Name = "label20";
    this.label20.Size = new Size(19, 16);
    this.label20.TabIndex = 35;
    this.label20.Text = "%";
    this.label13.AutoSize = true;
    this.label13.Location = new Point(142, 3);
    this.label13.Name = "label13";
    this.label13.Size = new Size(24, 16);
    this.label13.TabIndex = 35;
    this.label13.Text = "lần";
    this.label14.Location = new Point(57, 3);
    ...
    this.label19.Location = new Point(182, 3);
    this.label19.Name = "label19";
    this.label19.Size = new Size(55, 16);
    this.label19.TabIndex = 35;
    this.label19.Text = "Percent:";
    this.nudCountCommentTo.Location = new Point(86, 1);
    ...
    this.plCountShareWall.Controls.Add((Control) this.nudPercentShare);
    this.plCountShareWall.Controls.Add((Control) this.nudCountShareFrom);
    this.plCountShareWall.Controls.Add((Control) this.label18);
    this.plCountShareWall.Controls.Add((Control) this.label11);
    this.plCountShareWall.Controls.Add((Control) this.label17);
    this.plCountShareWall.Controls.Add((Control) this.label12);
    this.plCountShareWall.Controls.Add((Control) this.nudCountShareTo);
    this.plCountShareWall.Location = new Point(132, 136);
    this.plCountShareWall.Name = "plCountShareWall";
    this.plCountShareWall.Size = new Size(186, 25);
    this.plCountShareWall.TabIndex = 43;
    this.nudPercentShare.Location = new Point(237, 1);
    this.nudPercentShare.Name = "nudPercentShare";
    this.nudPercentShare.Size = new Size(44, 23);
    this.nudPercentShare.TabIndex = 38;
    this.nudPercentShare.Value = new Decimal(new int[4]
    {
      100,
      0,
      0,
    ...
    this.label18.Location = new Point(283, 3);
    this.label18.Name = "label18";
    this.label18.Size = new Size(19, 16);
    this.label18.TabIndex = 35;
    this.label18.Text = "%";
    this.label11.AutoSize = true;
    this.label11.Location = new Point(142, 3);
    this.label11.Name = "label11";
    this.label11.Size = new Size(24, 16);
    this.label11.TabIndex = 35;
    this.label11.Text = "lần";
    this.label17.AutoSize = true;
    this.label17.Location = new Point(182, 3);
    this.label17.Name = "label17";
    this.label17.Size = new Size(55, 16);
    this.label17.TabIndex = 35;
    this.label17.Text = "Percent:";
    this.label12.Location = new Point(57, 3);
    this.label12.Name = "label12";
    this.label12.Size = new Size(29, 16);
    this.label12.TabIndex = 37;
    this.label12.Text = "đến";
    this.label12.TextAlign = ContentAlignment.MiddleCenter;
    this.nudCountShareTo.Location = new Point(86, 1);
    ...
    this.plCountLike.Controls.Add((Control) this.nudPercentLike);
    this.plCountLike.Controls.Add((Control) this.nudCountLikeFrom);
    this.plCountLike.Controls.Add((Control) this.label16);
    this.plCountLike.Controls.Add((Control) this.label15);
    ...
    this.plCountLike.Location = new Point(132, 106);
    this.plCountLike.Name = "plCountLike";
    this.plCountLike.Size = new Size(186, 25);
    this.plCountLike.TabIndex = 42;
    this.nudPercentLike.Location = new Point(237, 1);
    this.nudPercentLike.Name = "nudPercentLike";
    this.nudPercentLike.Size = new Size(44, 23);
    this.nudPercentLike.TabIndex = 38;
    this.nudPercentLike.Value = new Decimal(new int[4]
    {
      100,
      0,
      0,
    ...
    this.label16.Location = new Point(283, 3);
    this.label16.Name = "label16";
    this.label16.Size = new Size(19, 16);
    this.label16.TabIndex = 35;
    this.label16.Text = "%";
    this.label15.AutoSize = true;
    this.label15.Location = new Point(182, 3);
    this.label15.Name = "label15";
    this.label15.Size = new Size(55, 16);
    this.label15.TabIndex = 35;
    this.label15.Text = "Percent:";
    this.label9.AutoSize = true;
    this.label9.Location = new Point(142, 3);
    this.label9.Name = "label9";
    this.label9.Size = new Size(24, 16);
    this.label9.TabIndex = 35;
    this.label9.Text = "lần";
    this.label10.Location = new Point(57, 3);
    this.label10.Name = "label10";
    this.label10.Size = new Size(29, 16);
    this.label10.TabIndex = 37;
    this.label10.Text = "đến";
    this.label10.TextAlign = ContentAlignment.MiddleCenter;
    this.nudCountLikeTo.Location = new Point(86, 1);
    ...
    this.plComment.Location = new Point(48, 196);
    this.plComment.Name = "plComment";
    this.plComment.Size = new Size(285, 164);
    ...
    this.txtComment.Size = new Size(271, 114);
    ...
    this.ckbComment.Location = new Point(30, 168);
    ...
    this.ckbShareWall.Location = new Point(30, 138);
    ...
    this.ckbInteract.Location = new Point(30, 108);
    ...
    this.txtTenHanhDong.Size = new Size(201, 23);
    ...
    this.btnCancel.Location = new Point(189, 378);
    ...
    this.btnAdd.Location = new Point(82, 378);
    ...
    this.bunifuCards1.Size = new Size(356, 37);
    this.bunifuCards1.TabIndex = 28;
    this.AutoScaleDimensions = new SizeF(7f, 16f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.ClientSize = new Size(359, 424);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDXemWatch);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDXemWatch_Load);
    ...
    this.nudPercentComment.EndInit();
