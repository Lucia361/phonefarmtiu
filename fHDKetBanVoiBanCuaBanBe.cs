...
public class fHDKetBanVoiBanCuaBanBe : Form
{
  ...
  public fHDKetBanVoiBanCuaBanBe(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDKetBanVoiBanCuaBanBe.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDKetBanVoiBanCuaBanBe").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanVoiBanCuaBanBe', 'Kết bạn với bạn của Bạn bè');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDKetBanVoiBanCuaBanBe");
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDKetBanVoiBanCuaBanBe.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void InitializeComponent()
  {
    ...
    this.panel1.Size = new Size(362, 187);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.nudTimesWarning.Location = new Point(253, 220);
    ...
    this.label9.Location = new Point(299, 222);
    ...
    this.label6.Location = new Point(290, 114);
    this.label6.Name = "label6";
    this.label6.Size = new Size(30, 16);
    this.label6.TabIndex = 45;
    this.label6.Text = "giây";
    this.label8.AutoSize = true;
    this.label8.Location = new Point(27, 222);
    ...
    this.label4.Location = new Point(290, 83);
    ...
    this.btnCancel.Location = new Point(193, 146);
    ...
    this.btnAdd.Location = new Point(86, 146);
    ...
    this.ClientSize = new Size(362, 187);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDKetBanVoiBanCuaBanBe);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDKetBanVoiBanCuaBanBe_Load);
