...
public class fHDXoaSdt : Form
{
  ...
  public fHDXoaSdt(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDXoaSdt.bool_0 = false;
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDXoaSdt));
    ...
    this.Name = nameof (fHDXoaSdt);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDXoaSdt_Load);
