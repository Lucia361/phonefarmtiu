...
public class fNhapProxy : Form
{
  ...
  public fNhapProxy()
  {
    ...
    if (!File.Exists("settings\\proxy.txt"))
      return;
    this.txtData.Lines = File.ReadAllLines("settings\\proxy.txt");
  }
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      File.WriteAllLines("settings\\proxy.txt", (IEnumerable<string>) this.list_0);
      this.Close();
    }
    catch (Exception ex)
    {
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fNhapProxy));
    ...
    this.label4.Location = new Point(281, 58);
    this.label4.Name = "label4";
    this.label4.Size = new Size(123, 16);
    this.label4.TabIndex = 122;
    this.label4.Text = "(Định dạng: Ip:Port)";
