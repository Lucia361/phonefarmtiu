...
public class fHDNghiGiaiLao : Form
{
  ...
  public fHDNghiGiaiLao(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDNghiGiaiLao.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDNghiGiaiLao").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDNghiGiaiLao', 'Nghỉ giải lao');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDNghiGiaiLao");
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDNghiGiaiLao));
    ...
    this.panel1.Size = new Size(362, 160);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.nudDelayTo.Location = new Point(229, 80);
    ...
    this.nudDelayFrom.Location = new Point(132, 80);
    ...
    this.label7.Location = new Point(194, 82);
    ...
    this.label6.Location = new Point(287, 82);
    ...
    this.btnCancel.Location = new Point(189, 116);
    ...
    this.btnAdd.Location = new Point(82, 116);
    ...
    this.ClientSize = new Size(362, 160);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDNghiGiaiLao);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDNghiGiaiLao_Load);
