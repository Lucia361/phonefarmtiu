...
public class fHDBaiVietNhom : Form
{
  ...
  public fHDBaiVietNhom(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDBaiVietNhom");
  ...
  private void fHDBaiVietNhom_Load(object sender, EventArgs e)
  {
    try
    {
      this.nudSoLuongNhomFrom.Value = (Decimal) Convert.ToInt32((object) this.jobject_0["nudSoLuongNhomFrom"]);
      this.nudSoLuongNhomTo.Value = (Decimal) Convert.ToInt32((object) this.jobject_0["nudSoLuongNhomTo"]);
      ...
      this.ckbSendAnh.Checked = Convert.ToBoolean((object) this.jobject_0["ckbSendAnh"]);
      this.txtAnh.Text = this.jobject_0["txtAnh"].ToString();
    }
    catch
    {
    }
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    if (this.int_0 == 0)
    {
      ...
      else
      {
        ...
        gclass22.method_6("nudSoLuongNhomFrom", (object) this.nudSoLuongNhomFrom.Value);
        gclass22.method_6("nudSoLuongNhomTo", (object) this.nudSoLuongNhomTo.Value);
  ...
  private void method_3()
  {
    ...
    this.ckbSendAnh_CheckedChanged((object) null, (EventArgs) null);
  }
  ...
  private void button2_Click(object sender, EventArgs e) => this.txtAnh.Text = GClass19.smethod_45();

  private void button3_Click(object sender, EventArgs e) => GClass14.smethod_0((object) GClass35.smethod_0("Có thể dùng [u] để thay thế tên của người đăng bài!"));
  ...
  private void InitializeComponent()
  {
    ...
    this.nudSoLuongNhomFrom = new NumericUpDown();
    this.label68 = new Label();
    this.label19 = new Label();
    this.nudSoLuongNhomTo = new NumericUpDown();
    ...
    this.nudSoLuongNhomFrom.BeginInit();
    this.nudSoLuongNhomTo.BeginInit();
    ...
    this.panel1.Controls.Add((Control) this.nudSoLuongNhomFrom);
    this.panel1.Controls.Add((Control) this.label68);
    this.panel1.Controls.Add((Control) this.label19);
    this.panel1.Controls.Add((Control) this.nudSoLuongNhomTo);
    ...
    this.plComment.Location = new Point(369, 84);
    ...
    this.label49.Size = new Size(99, 16);
    this.label49.TabIndex = 92;
    this.label49.Text = "Số lượng nhóm:";
    this.nudSoLuongNhomFrom.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 163);
    this.nudSoLuongNhomFrom.Location = new Point(135, 79);
    this.nudSoLuongNhomFrom.Maximum = new Decimal(new int[4]
    {
      99999,
      0,
      0,
    ...
    this.nudSoLuongNhomFrom.Size = new Size(56, 23);
    this.nudSoLuongNhomFrom.TabIndex = 1;
    this.nudSoLuongNhomFrom.Value = new Decimal(new int[4]
    {
      5,
      0,
      0,
    ...
    this.label68.Location = new Point(293, 81);
    this.label68.Name = "label68";
    this.label68.Size = new Size(39, 16);
    ...
    this.label19.Size = new Size(85, 16);
    this.label19.TabIndex = 101;
    this.label19.Text = "Số bài/nhóm:";
    this.nudSoLuongNhomTo.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 163);
    this.nudSoLuongNhomTo.Location = new Point(232, 79);
    this.nudSoLuongNhomTo.Maximum = new Decimal(new int[4]
    {
      99999,
      0,
      0,
    ...
    this.nudSoLuongNhomTo.Size = new Size(56, 23);
    this.nudSoLuongNhomTo.TabIndex = 2;
    this.nudSoLuongNhomTo.Value = new Decimal(new int[4]
    {
      10,
      0,
      0,
    ...
    this.ckbComment.Location = new Point(369, 62);
    ...
    this.ckbShareWall.Location = new Point(135, 171);
    ...
    this.label6.Location = new Point(293, 142);
    this.label6.Name = "label6";
    this.label6.Size = new Size(30, 16);
    this.label6.TabIndex = 36;
    this.label6.Text = "giây";
    this.label4.AutoSize = true;
    this.label4.Location = new Point(293, 112);
    ...
    this.btnCancel.Location = new Point(351, 263);
    ...
    this.btnAdd.Location = new Point(244, 263);
    ...
    this.ClientSize = new Size(683, 308);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDBaiVietNhom);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDBaiVietNhom_Load);
    ...
    this.nudSoLuongNhomFrom.EndInit();
    this.nudSoLuongNhomTo.EndInit();
