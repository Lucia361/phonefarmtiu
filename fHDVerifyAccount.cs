...
public class fHDVerifyAccount : Form
{
  ...
  private RadioButton rbMailDomain;
  private RadioButton rbHotmail;
  private IContainer components;
  private Button btnNhapMailDomain;

  public fHDVerifyAccount(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDVerifyAccount.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    string string_1_1 = this.Name.Substring(1);
    string str = "Verify Account";
  ...
  private void fHDVerifyAccount_Load(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass22_0.method_3("typeMail") == 0)
        this.rbHotmail.Checked = true;
      else
        this.rbMailDomain.Checked = true;
      this.list_0 = this.gclass22_0.method_2("lstHotmail");
      GClass19.smethod_6((Control) this.btnNhapHotmail, this.list_0.Count);
      this.list_1 = this.gclass22_0.method_2("lstMailDomain");
      GClass19.smethod_6((Control) this.btnNhapMailDomain, this.list_1.Count);
    }
    catch
    {
    }
    ...
    this.rbHotmail_CheckedChanged((object) null, (EventArgs) null);
    this.rbMailDomain_CheckedChanged((object) null, (EventArgs) null);
  }
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      int object_0 = 0;
      if (this.rbMailDomain.Checked)
        object_0 = 1;
      gclass22.method_6("typeMail", (object) object_0);
  ...
  {
    fNhapDuLieu1 form_0 = new fNhapDuLieu1(this.list_0, "Nhập danh sách hotmail (mail|pass mail)", "Danh sách mail|pass mail", "(Mỗi nội dung 1 dòng)");
  ...
  private void rbHotmail_CheckedChanged(object sender, EventArgs e) => this.btnNhapHotmail.Enabled = this.rbHotmail.Checked;

  private void rbMailDomain_CheckedChanged(object sender, EventArgs e) => this.btnNhapMailDomain.Enabled = this.rbMailDomain.Checked;

  private void btnNhapMailDomain_Click(object sender, EventArgs e)
  {
    fNhapDuLieu1 form_0 = new fNhapDuLieu1(this.list_1, "Nhập danh sách link mail domain", "Danh sách link mail domain", "(Mỗi nội dung 1 dòng)");
    GClass19.smethod_35((Form) form_0);
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDVerifyAccount));
    ...
    this.rbMailDomain = new RadioButton();
    this.rbHotmail = new RadioButton();
    this.btnNhapMailDomain = new Button();
    this.btnNhapHotmail = new Button();
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình Verify Account";
    ...
    this.button1.Location = new Point(321, 1);
    ...
    this.panel1.Controls.Add((Control) this.rbMailDomain);
    this.panel1.Controls.Add((Control) this.rbHotmail);
    this.panel1.Controls.Add((Control) this.btnNhapMailDomain);
    this.panel1.Controls.Add((Control) this.btnNhapHotmail);
    ...
    this.panel1.Size = new Size(355, 195);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.rbMailDomain.AutoSize = true;
    this.rbMailDomain.Cursor = Cursors.Hand;
    this.rbMailDomain.Location = new Point(23, 112);
    this.rbMailDomain.Name = "rbMailDomain";
    this.rbMailDomain.Size = new Size(94, 20);
    this.rbMailDomain.TabIndex = 117;
    this.rbMailDomain.TabStop = true;
    this.rbMailDomain.Text = "Mail domain";
    this.rbMailDomain.UseVisualStyleBackColor = true;
    this.rbMailDomain.CheckedChanged += new EventHandler(this.rbMailDomain_CheckedChanged);
    this.rbHotmail.AutoSize = true;
    this.rbHotmail.Cursor = Cursors.Hand;
    this.rbHotmail.Location = new Point(23, 81);
    this.rbHotmail.Name = "rbHotmail";
    this.rbHotmail.Size = new Size(68, 20);
    this.rbHotmail.TabIndex = 117;
    this.rbHotmail.TabStop = true;
    this.rbHotmail.Text = "Hotmail";
    this.rbHotmail.UseVisualStyleBackColor = true;
    this.rbHotmail.CheckedChanged += new EventHandler(this.rbHotmail_CheckedChanged);
    this.btnNhapMailDomain.Cursor = Cursors.Hand;
    this.btnNhapMailDomain.Location = new Point(125, 109);
    this.btnNhapMailDomain.Name = "btnNhapMailDomain";
    this.btnNhapMailDomain.Size = new Size(194, 27);
    this.btnNhapMailDomain.TabIndex = 116;
    this.btnNhapMailDomain.Text = "Nhập (0)";
    this.btnNhapMailDomain.UseVisualStyleBackColor = true;
    this.btnNhapMailDomain.Click += new EventHandler(this.btnNhapMailDomain_Click);
    this.btnNhapHotmail.Cursor = Cursors.Hand;
    this.btnNhapHotmail.Location = new Point(125, 78);
    this.btnNhapHotmail.Name = "btnNhapHotmail";
    this.btnNhapHotmail.Size = new Size(194, 27);
    this.btnNhapHotmail.TabIndex = 116;
    this.btnNhapHotmail.Text = "Nhập (0)";
    this.btnNhapHotmail.UseVisualStyleBackColor = true;
    this.btnNhapHotmail.Click += new EventHandler(this.btnNhapHotmail_Click);
    ...
    this.btnCancel.Location = new Point(187, 152);
    ...
    this.btnAdd.Location = new Point(80, 152);
    ...
    this.ClientSize = new Size(355, 195);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDVerifyAccount);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDVerifyAccount_Load);
