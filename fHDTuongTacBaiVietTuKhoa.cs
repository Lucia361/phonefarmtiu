...
public class fHDTuongTacBaiVietTuKhoa : Form
{
  ...
  public fHDTuongTacBaiVietTuKhoa(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDTuongTacBaiVietTuKhoa.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDTuongTacBaiVietTuKhoa").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTuongTacBaiVietTuKhoa', 'Tương tác Bài viết từ khóa');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDTuongTacBaiVietTuKhoa");
  ...
  private void fHDTuongTacBaiVietTuKhoa_Load(object sender, EventArgs e)
  {
    try
    {
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDTuongTacBaiVietTuKhoa.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void txtTuKhoa_TextChanged(object sender, EventArgs e) => GClass19.smethod_5(this.txtTuKhoa, (Control) this.label10);
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDTuongTacBaiVietTuKhoa));
    ...
    this.bunifuCustomLabel1.Size = new Size(709, 31);
    this.bunifuCustomLabel1.TabIndex = 12;
    this.bunifuCustomLabel1.Text = "Cấu hình Tương tác Bài viết từ khóa";
    ...
    this.pnlHeader.Size = new Size(709, 31);
    ...
    this.button1.Location = new Point(678, 1);
    ...
    this.panel1.Size = new Size(712, 450);
    ...
    this.plInteract.Location = new Point(367, 77);
    ...
    this.txtTuKhoa.BorderStyle = BorderStyle.FixedSingle;
    this.txtTuKhoa.Location = new Point(31, 153);
    this.txtTuKhoa.Name = "txtTuKhoa";
    this.txtTuKhoa.Size = new Size(295, 222);
    this.txtTuKhoa.TabIndex = 179;
    this.txtTuKhoa.Text = "";
    this.txtTuKhoa.WordWrap = false;
    this.txtTuKhoa.TextChanged += new EventHandler(this.txtTuKhoa_TextChanged);
    this.label2.AutoSize = true;
    this.label2.Location = new Point(28, 377);
    this.label2.Name = "label2";
    this.label2.Size = new Size(259, 16);
    this.label2.TabIndex = 177;
    this.label2.Text = "(Mỗi từ khóa 1 dòng, spin nội dung {a|b|c})";
    this.label10.AutoSize = true;
    this.label10.Location = new Point(27, 134);
    this.label10.Name = "label10";
    this.label10.Size = new Size(139, 16);
    this.label10.TabIndex = 178;
    this.label10.Text = "Danh sách từ khóa (0):";
    ...
    this.plAnh.Location = new Point(366, 363);
    ...
    this.ckbAnh.Location = new Point(349, 339);
    ...
    this.ckbInteract.Location = new Point(349, 51);
    ...
    this.plComment.Location = new Point(367, 142);
    ...
    this.ckbComment.Location = new Point(349, 118);
    ...
    this.txtTenHanhDong.Size = new Size(189, 23);
    ...
    this.btnCancel.Location = new Point(364, 408);
    ...
    this.btnAdd.Location = new Point(257, 408);
    ...
    this.bunifuCards1.Size = new Size(709, 37);
    this.bunifuCards1.TabIndex = 28;
    this.AutoScaleDimensions = new SizeF(7f, 16f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.ClientSize = new Size(712, 450);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDTuongTacBaiVietTuKhoa);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDTuongTacBaiVietTuKhoa_Load);
