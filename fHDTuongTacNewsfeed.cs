...
public class fHDTuongTacNewsfeed : Form
{
  ...
  public fHDTuongTacNewsfeed(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDTuongTacNewsfeed.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDTuongTacNewsfeed").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTuongTacNewsfeed', 'Tương tác Newsfeed');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDTuongTacNewsfeed");
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDTuongTacNewsfeed.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDTuongTacNewsfeed));
    ...
    this.Name = nameof (fHDTuongTacNewsfeed);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDTuongTacNewsfeed_Load);
