...
public class fHDChocBanBe : Form
{
  ...
  public fHDChocBanBe(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDChocBanBe");
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDChocBanBe));
    ...
    this.panel1.Size = new Size(362, 199);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.nudDelayTo.Location = new Point(229, 115);
    ...
    this.nudSoLuongTo.Location = new Point(229, 84);
    ...
    this.nudDelayFrom.Location = new Point(132, 115);
    ...
    this.nudSoLuongFrom.Location = new Point(132, 84);
    ...
    this.label7.Location = new Point(194, 117);
    this.label7.Name = "label7";
    this.label7.Size = new Size(29, 16);
    this.label7.TabIndex = 38;
    this.label7.Text = "đến";
    this.label7.TextAlign = ContentAlignment.MiddleCenter;
    this.label3.Location = new Point(194, 86);
    ...
    this.btnCancel.Location = new Point(189, 154);
    ...
    this.btnAdd.Location = new Point(82, 154);
    ...
    this.ClientSize = new Size(362, 199);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDChocBanBe);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDChocBanBe_Load);
