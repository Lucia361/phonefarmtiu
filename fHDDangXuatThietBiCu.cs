...
public class fHDDangXuatThietBiCu : Form
{
  ...
  public fHDDangXuatThietBiCu(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDDangXuatThietBiCu.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    string string_1_1 = this.Name.Substring(1);
    string str = "Đăng xuất thiết bị cũ";
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDDangXuatThietBiCu.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void InitializeComponent()
  {
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình Đăng xuất thiết bị cũ";
    ...
    this.panel1.Size = new Size(362, 142);
    ...
    this.btnCancel.Location = new Point(189, 98);
    ...
    this.btnAdd.Location = new Point(82, 98);
    ...
    this.ClientSize = new Size(362, 142);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDDangXuatThietBiCu);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDDangXuatThietBiCu_Load);
