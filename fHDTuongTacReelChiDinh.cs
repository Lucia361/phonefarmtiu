...
public class fHDTuongTacReelChiDinh : Form
{
  ...
  public fHDTuongTacReelChiDinh(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDTuongTacReelChiDinh.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    string string_1_1 = this.Name.Substring(1);
    string str = "Tương tác Reel chỉ định";
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDTuongTacReelChiDinh.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDTuongTacReelChiDinh));
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình Tương tác Reel chỉ định";
    ...
    this.button1.Location = new Point(328, 2);
    ...
    this.panel1.Size = new Size(362, 411);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.label2.AutoSize = true;
    this.label2.Location = new Point(27, 81);
    this.label2.Name = "label2";
    this.label2.Size = new Size(102, 16);
    this.label2.TabIndex = 42;
    this.label2.Text = "Link thước phim:";
    this.txtIdPost.Location = new Point(132, 78);
    this.txtIdPost.Name = "txtIdPost";
    this.txtIdPost.Size = new Size(194, 23);
    this.txtIdPost.TabIndex = 41;
    ...
    this.plComment.Location = new Point(48, 186);
    ...
    this.ckbComment.Location = new Point(30, 160);
    ...
    this.ckbShareWall.Location = new Point(132, 134);
    ...
    this.ckbInteract.Location = new Point(30, 134);
    ...
    this.nudTimeTo.Location = new Point(229, 107);
    ...
    this.nudTimeFrom.Location = new Point(132, 107);
    ...
    this.label7.Location = new Point(194, 109);
    ...
    this.label6.Location = new Point(290, 109);
    ...
    this.btnCancel.Location = new Point(189, 368);
    ...
    this.btnAdd.Location = new Point(82, 368);
    ...
    this.ClientSize = new Size(362, 411);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDTuongTacReelChiDinh);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDTuongTacReelChiDinh_Load);
