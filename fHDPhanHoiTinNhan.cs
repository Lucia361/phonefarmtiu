...
public class fHDPhanHoiTinNhan : Form
{
  ...
  public fHDPhanHoiTinNhan(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDPhanHoiTinNhan.bool_0 = false;
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDPhanHoiTinNhan");
  ...
  private void button2_Click(object sender, EventArgs e) => GClass14.smethod_0((object) GClass35.smethod_0("Có thể dùng [u] để thay thế tên của người nhận!"));
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDPhanHoiTinNhan));
    ...
    this.panel1.Size = new Size(362, 385);
    ...
    this.button2.Location = new Point(304, 302);
    ...
    this.txtTinNhan.Location = new Point(31, 164);
    ...
    this.btnCancel.Location = new Point(185, 336);
    ...
    this.btnAdd.Location = new Point(78, 336);
    ...
    this.ClientSize = new Size(362, 385);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDPhanHoiTinNhan);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDPhanHoiTinNhan_Load);
