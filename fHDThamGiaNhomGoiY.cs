...
public class fHDThamGiaNhomGoiY : Form
{
  ...
  public fHDThamGiaNhomGoiY(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDThamGiaNhomGoiY.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDThamGiaNhomGoiY").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDThamGiaNhomGoiY', 'Tham gia nhóm gợi ý');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDThamGiaNhomGoiY");
  ...
  private void fHDThamGiaNhomGoiY_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.ckbTuDongTraLoiCauHoi.Checked = this.gclass22_0.method_4("ckbTuDongTraLoiCauHoi");
      this.txtCauTraLoi.Text = this.gclass22_0.method_1("txtCauTraLoi");
    }
    catch
    {
    }
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDThamGiaNhomGoiY.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void InitializeComponent()
  {
    ...
    this.panel1.Size = new Size(366, 395);
    ...
    this.plTuongTac.Location = new Point(48, 158);
    ...
    this.ckbTuDongTraLoiCauHoi.Location = new Point(30, 135);
    ...
    this.nudDelayTo.Location = new Point(229, 107);
    ...
    this.nudDelayFrom.Location = new Point(132, 107);
    ...
    this.label6.Location = new Point(287, 109);
    ...
    this.btnCancel.Location = new Point(193, 352);
    ...
    this.btnAdd.Location = new Point(86, 352);
    ...
    this.ClientSize = new Size(366, 395);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDThamGiaNhomGoiY);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDThamGiaNhomGoiY_Load);
