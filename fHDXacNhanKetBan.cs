...
public class fHDXacNhanKetBan : Form
{
  ...
  public fHDXacNhanKetBan(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDXacNhanKetBan");
  ...
  private void fHDXacNhanKetBan_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.nudSoLuongTo.Value = (Decimal) this.gclass22_0.method_3("nudSoLuongTo", 3);
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDXacNhanKetBan));
    ...
    this.panel1.Size = new Size(362, 192);
    ...
    this.ckbOnlyAddFriendWithMutualFriends.Location = new Point(30, 231);
    ...
    this.ckbChiKetBanTenCoDau.Location = new Point(30, 207);
    ...
    this.btnCancel.Location = new Point(189, 148);
    ...
    this.btnAdd.Location = new Point(82, 148);
    ...
    this.ClientSize = new Size(362, 192);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDXacNhanKetBan);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDXacNhanKetBan_Load);
