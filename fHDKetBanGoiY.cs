...
public class fHDKetBanGoiY : Form
{
  ...
  public fHDKetBanGoiY(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDKetBanGoiY");
  ...
  private void method_0()
  {
    ...
    GClass35.smethod_1((Control) this.ckbChiKetBanTenCoDau);
    GClass35.smethod_1((Control) this.ckbOnlyAddFriendWithMutualFriends);
  ...
  private void fHDKetBanGoiY_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.ckbChiKetBanTenCoDau.Checked = this.gclass22_0.method_4("ckbChiKetBanTenCoDau");
      this.ckbOnlyAddFriendWithMutualFriends.Checked = this.gclass22_0.method_4("ckbOnlyAddFriendWithMutualFriends");
      this.nudTimesWarning.Value = (Decimal) this.gclass22_0.method_3("nudTimesWarning", 3);
    }
    catch
    {
    }
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      gclass22.method_6("ckbChiKetBanTenCoDau", (object) this.ckbChiKetBanTenCoDau.Checked);
      gclass22.method_6("ckbOnlyAddFriendWithMutualFriends", (object) this.ckbOnlyAddFriendWithMutualFriends.Checked);
      gclass22.method_6("nudTimesWarning", (object) this.nudTimesWarning.Value);
  ...
  private void InitializeComponent()
  {
    ...
    this.ckbOnlyAddFriendWithMutualFriends = new CheckBox();
    this.ckbChiKetBanTenCoDau = new CheckBox();
    this.nudTimesWarning = new NumericUpDown();
    ...
    this.nudTimesWarning.BeginInit();
    ...
    this.panel1.Controls.Add((Control) this.ckbOnlyAddFriendWithMutualFriends);
    this.panel1.Controls.Add((Control) this.ckbChiKetBanTenCoDau);
    this.panel1.Controls.Add((Control) this.nudTimesWarning);
    ...
    this.panel1.Size = new Size(362, 193);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.ckbOnlyAddFriendWithMutualFriends.AutoSize = true;
    this.ckbOnlyAddFriendWithMutualFriends.Cursor = Cursors.Hand;
    this.ckbOnlyAddFriendWithMutualFriends.Location = new Point(30, 280);
    this.ckbOnlyAddFriendWithMutualFriends.Name = "ckbOnlyAddFriendWithMutualFriends";
    this.ckbOnlyAddFriendWithMutualFriends.Size = new Size(226, 20);
    ...
    this.ckbChiKetBanTenCoDau.Cursor = Cursors.Hand;
    this.ckbChiKetBanTenCoDau.Location = new Point(30, 254);
    this.ckbChiKetBanTenCoDau.Name = "ckbChiKetBanTenCoDau";
    this.ckbChiKetBanTenCoDau.Size = new Size(303, 20);
    this.ckbChiKetBanTenCoDau.TabIndex = 47;
    this.ckbChiKetBanTenCoDau.Text = "Chỉ kết bạn với tên có dấu (Kết bạn với nick Việt)";
    this.ckbChiKetBanTenCoDau.UseVisualStyleBackColor = true;
    this.nudTimesWarning.Location = new Point(253, 306);
    this.nudTimesWarning.Maximum = new Decimal(new int[4]
    {
      999999,
      0,
      0,
    ...
    this.nudTimesWarning.Size = new Size(43, 23);
    this.nudTimesWarning.TabIndex = 4;
    this.nudDelayTo.Location = new Point(229, 112);
    ...
    this.nudDelayFrom.Location = new Point(132, 112);
    ...
    this.label9.Location = new Point(299, 308);
    this.label9.Name = "label9";
    this.label9.Size = new Size(24, 16);
    this.label9.TabIndex = 45;
    this.label9.Text = "lần";
    this.label7.Location = new Point(194, 114);
    ...
    this.nudSoLuongFrom.Location = new Point(132, 81);
    ...
    this.label3.Location = new Point(194, 83);
    ...
    this.label4.Location = new Point(287, 83);
    this.label4.Name = "label4";
    this.label4.Size = new Size(28, 16);
    this.label4.TabIndex = 35;
    this.label4.Text = "bạn";
    this.label2.AutoSize = true;
    this.label2.Location = new Point(27, 83);
    ...
    this.btnCancel.Location = new Point(187, 151);
    ...
    this.btnAdd.Location = new Point(80, 151);
    ...
    this.ClientSize = new Size(362, 193);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDKetBanGoiY);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDKetBanGoiY_Load);
    this.pnlHeader.ResumeLayout(false);
    this.panel1.ResumeLayout(false);
    this.panel1.PerformLayout();
    this.nudTimesWarning.EndInit();
