...
public class fHDChaySeeding : Form
{
  ...
  public fHDChaySeeding(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDChaySeeding.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    string string_1_1 = this.Name.Substring(1);
    string str = "Chạy Seeding";
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    {
      this.gclass22_0.method_6("nudDelayFrom", (object) this.nudDelayFrom.Value);
      this.gclass22_0.method_6("nudDelayTo", (object) this.nudDelayTo.Value);
      string str = this.gclass22_0.method_11();
      if (this.int_0 == 0)
      {
  ...
  private void InitializeComponent()
  {
    ...
    this.panel1.Size = new Size(362, 162);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.nudDelayTo.Location = new Point(229, 78);
    ...
    this.nudDelayFrom.TabIndex = 39;
    this.label7.Font = new Font("Tahoma", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
    ...
    this.label6.Location = new Point(287, 80);
    ...
    this.label5.Size = new Size(105, 16);
    this.label5.TabIndex = 41;
    this.label5.Text = "Delay giữa 2 job:";
    ...
    this.btnCancel.Location = new Point(189, 118);
    ...
    this.btnAdd.Location = new Point(82, 118);
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình Chạy Seeding";
    this.bunifuCustomLabel1.TextAlign = ContentAlignment.MiddleCenter;
    this.AutoScaleDimensions = new SizeF(7f, 16f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.ClientSize = new Size(362, 162);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDChaySeeding);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDChaySeeding_Load);
