...
public class fHDSpamBanBe : Form
{
  ...
  public fHDSpamBanBe(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDSpamBanBe.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDSpamBanBe").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDSpamBanBe', 'Spam bạn bè');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDSpamBanBe");
  ...
  private void fHDSpamBanBe_Load(object sender, EventArgs e)
  {
    try
    {
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDSpamBanBe));
    ...
    this.bunifuCustomLabel1.Size = new Size(389, 31);
    this.bunifuCustomLabel1.TabIndex = 12;
    this.bunifuCustomLabel1.Text = "Cấu hình Spam bạn bè";
    ...
    this.pnlHeader.Size = new Size(389, 31);
    ...
    this.button1.Location = new Point(358, 1);
    ...
    this.panel1.Size = new Size(392, 592);
    ...
    this.plInteract.Location = new Point(48, 191);
    ...
    this.plAnh.Location = new Point(49, 504);
    ...
    this.ckbAnh.Location = new Point(32, 480);
    ...
    this.ckbInteract.Location = new Point(30, 165);
    ...
    this.plComment.Location = new Point(48, 256);
    this.plComment.Name = "plComment";
    this.plComment.Size = new Size(312, 218);
    this.plComment.TabIndex = 10;
    this.linkLabel1.AutoSize = true;
    this.linkLabel1.Cursor = Cursors.Hand;
    this.linkLabel1.Location = new Point(190, 152);
    ...
    this.button3.Location = new Point(228, 194);
    ...
    this.button2.Location = new Point(228, 171);
    ...
    this.rbNganCachKyTu.Location = new Point(70, 193);
    ...
    this.rbNganCachMoiDong.Location = new Point(70, 172);
    ...
    this.label9.Location = new Point(5, 172);
    ...
    this.txtComment.Size = new Size(294, 124);
    ...
    this.label8.Location = new Point(4, 152);
    ...
    this.label49.Size = new Size(88, 16);
    this.label49.TabIndex = 92;
    this.label49.Text = "Số lượng bạn:";
    ...
    this.ckbComment.Location = new Point(30, 232);
    ...
    this.nudDelayTo.Location = new Point(234, 136);
    ...
    this.nudSoLuongBaiVietTo.Location = new Point(234, 107);
    ...
    this.nudDelayFrom.Location = new Point(137, 136);
    ...
    this.nudSoLuongBaiVietFrom.Location = new Point(137, 107);
    ...
    this.txtTenHanhDong.TextChanged += new EventHandler(this.txtTenHanhDong_TextChanged);
    this.label7.Location = new Point(199, 138);
    this.label7.Name = "label7";
    this.label7.Size = new Size(29, 16);
    this.label7.TabIndex = 38;
    this.label7.Text = "đến";
    this.label7.TextAlign = ContentAlignment.MiddleCenter;
    this.label3.Location = new Point(199, 109);
    ...
    this.label6.Location = new Point(292, 138);
    this.label6.Name = "label6";
    this.label6.Size = new Size(30, 16);
    this.label6.TabIndex = 36;
    this.label6.Text = "giây";
    this.label4.AutoSize = true;
    this.label4.Location = new Point(292, 109);
    this.label4.Name = "label4";
    this.label4.Size = new Size(24, 16);
    this.label4.TabIndex = 35;
    this.label4.Text = "bài";
    this.label5.AutoSize = true;
    this.label5.Location = new Point(27, 138);
    ...
    this.btnCancel.Location = new Point(211, 547);
    ...
    this.btnAdd.Location = new Point(104, 547);
    ...
    this.bunifuCards1.Size = new Size(389, 37);
    this.bunifuCards1.TabIndex = 28;
    this.label2.AutoSize = true;
    this.label2.Location = new Point(467, 105);
    ...
    this.ClientSize = new Size(392, 593);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDSpamBanBe);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDSpamBanBe_Load);
  ...
  private void txtTenHanhDong_TextChanged(object sender, EventArgs e)
  {
  }
}
