...
public class fHDSpamNhom : Form
{
  ...
  public fHDSpamNhom(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDSpamNhom.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDSpamNhom").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDSpamNhom', 'Spam nhóm');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDSpamNhom");
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDSpamNhom));
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình Spam nhóm";
    ...
    this.panel1.Size = new Size(394, 566);
    ...
    this.plInteract.Location = new Point(48, 192);
    ...
    this.plAnh.Location = new Point(47, 478);
    ...
    this.ckbAnh.Location = new Point(30, 454);
    ...
    this.ckbInteract.Location = new Point(30, 166);
    ...
    this.plComment.Location = new Point(48, 257);
    ...
    this.label19.Size = new Size(109, 16);
    this.label19.TabIndex = 101;
    this.label19.Text = "Số bài viết/nhóm:";
    ...
    this.ckbComment.Location = new Point(30, 233);
    ...
    this.btnCancel.Location = new Point(205, 524);
    ...
    this.btnAdd.Location = new Point(98, 524);
    ...
    this.ClientSize = new Size(394, 566);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDSpamNhom);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDSpamNhom_Load);
