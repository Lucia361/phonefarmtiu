...
public class fHDXemWatchTheoTuKhoa : Form
{
  ...
  public fHDXemWatchTheoTuKhoa(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDXemWatchTheoTuKhoa.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDXemWatchTheoTuKhoa").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDXemWatchTheoTuKhoa', '" + GClass35.smethod_0("Xem watch theo từ khóa") + "');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDXemWatchTheoTuKhoa");
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDXemWatchTheoTuKhoa.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void txtTuKhoa_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      this.label16.Text = string.Format(GClass35.smethod_0("({0})"), (object) stringList.Count.ToString());
    }
    catch
    {
    }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDXemWatchTheoTuKhoa));
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình Xem Watch theo từ khóa";
    ...
    this.panel1.Size = new Size(362, 491);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.nudTimeTo.Location = new Point(229, 155);
    ...
    this.nudTimeTo.TabIndex = 51;
    this.nudTimeFrom.Location = new Point(132, 155);
    ...
    this.nudTimeFrom.TabIndex = 50;
    this.label3.Location = new Point(194, 157);
    ...
    this.label4.Location = new Point(290, 157);
    this.label4.Name = "label4";
    this.label4.Size = new Size(30, 16);
    this.label4.TabIndex = 52;
    this.label4.Text = "giây";
    this.txtTuKhoa.Location = new Point(132, 77);
    this.txtTuKhoa.Name = "txtTuKhoa";
    this.txtTuKhoa.Size = new Size(195, 72);
    this.txtTuKhoa.TabIndex = 45;
    this.txtTuKhoa.Text = "";
    ...
    this.plCountComment.Location = new Point(131, 238);
    ...
    this.plCountShareWall.Location = new Point(131, 210);
    ...
    this.plCountLike.Location = new Point(131, 182);
    ...
    this.plComment.Location = new Point(47, 266);
    ...
    this.ckbComment.Location = new Point(29, 240);
    ...
    this.ckbShareWall.Location = new Point(29, 212);
    ...
    this.ckbInteract.Location = new Point(29, 184);
    ...
    this.btnCancel.Location = new Point(189, 448);
    ...
    this.btnAdd.Location = new Point(82, 448);
    ...
    this.ClientSize = new Size(362, 491);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDXemWatchTheoTuKhoa);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDXemWatchTheoTuKhoa_Load);
