...
public class fHDKetBanThanhVienNhom : Form
{
  ...
  public fHDKetBanThanhVienNhom(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDKetBanThanhVienNhom.bool_0 = false;
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDKetBanThanhVienNhom");
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDKetBanThanhVienNhom.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void txtUid_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      this.lblStatus.Text = string.Format(GClass35.smethod_0("Danh sách Uid nhóm ({0}):"), (object) stringList.Count.ToString());
    }
    catch
    {
    }
  ...
  private void InitializeComponent()
  {
    ...
    this.lblStatus.Size = new Size(150, 16);
    ...
    this.Name = nameof (fHDKetBanThanhVienNhom);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDKetBanThanhVienNhom_Load);
