...
public class fHDKetBanNewfeed : Form
{
  ...
  public fHDKetBanNewfeed(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    fHDKetBanNewfeed.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDKetBanNewfeed").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanNewfeed', 'Kết bạn Newfeed');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDKetBanNewfeed");
  ...
  private void InitializeComponent()
  {
    ...
    this.nudTimesWarning.Location = new Point(253, 221);
    ...
    this.label9.Location = new Point(299, 223);
    ...
    this.label8.Location = new Point(27, 223);
    ...
    this.btnCancel.Location = new Point(191, 148);
    ...
    this.btnAdd.Location = new Point(84, 148);
    ...
    this.Name = nameof (fHDKetBanNewfeed);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDKetBanNewfeed_Load);
