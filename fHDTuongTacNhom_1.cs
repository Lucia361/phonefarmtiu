...
public class fHDTuongTacNhom_1 : Form
{
  ...
  public fHDTuongTacNhom_1(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDTuongTacNhom_1.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDTuongTacNhom").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTuongTacNhom', '" + GClass35.smethod_0("Tương tác Nhóm") + "');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
  ...
  private void fHDTuongTacNhom_1_Load(object sender, EventArgs e)
  {
    try
    {
      this.nudSoLuongNhomFrom.Value = (Decimal) this.gclass22_0.method_3("nudSoLuongNhomFrom", 1);
      this.nudSoLuongNhomTo.Value = (Decimal) this.gclass22_0.method_3("nudSoLuongNhomTo", 3);
  ...
  private void InitializeComponent()
  {
    ...
    this.panel1.Size = new Size(362, 477);
    ...
    this.groupBox1.Text = " Cấu hình tương tác/Nhóm";
    ...
    this.button3.Location = new Point(224, 184);
    ...
    this.button2.Location = new Point(224, 161);
    ...
    this.nudSoLuongNhomFrom.Location = new Point(129, 80);
    ...
    this.nudSoLuongNhomFrom.TabIndex = 119;
    ...
    this.nudSoLuongNhomTo.Location = new Point(226, 80);
    ...
    this.nudSoLuongNhomTo.TabIndex = 120;
    ...
    this.btnCancel.Location = new Point(189, 432);
    ...
    this.btnAdd.Location = new Point(82, 432);
    ...
    this.ClientSize = new Size(362, 477);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDTuongTacNhom_1);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDTuongTacNhom_1_Load);
