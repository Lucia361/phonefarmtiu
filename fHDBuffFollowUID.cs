...
public class fHDBuffFollowUID : Form
{
  ...
  public fHDBuffFollowUID(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDBuffFollowUID.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDBuffFollowUID").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDBuffFollowUID', 'Buff Follow UID');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDBuffFollowUID");
  ...
  private void InitializeComponent()
  {
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình Buff Follow UID";
    ...
    this.lblUid.Size = new Size(97, 16);
    this.lblUid.TabIndex = 126;
    this.lblUid.Text = "UID cần Follow:";
    ...
    this.Name = nameof (fHDBuffFollowUID);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDBuffFollowUID_Load);
