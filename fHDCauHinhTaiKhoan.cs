...
public class fHDCauHinhTaiKhoan : Form
{
  ...
  public fHDCauHinhTaiKhoan(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDCauHinhTaiKhoan.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    if (Class205.smethod_13(string_1: "HDCauHinhTaiKhoan").Rows.Count == 0)
      GClass38.GClass38_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDCauHinhTaiKhoan', 'Cấu hình tài khoản');");
    string string_1 = "";
    switch (int_1)
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDCauHinhTaiKhoan");
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDCauHinhTaiKhoan.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void InitializeComponent()
  {
    ...
    this.bunifuCustomLabel1.Text = "Cấu hình tài khoản";
    ...
    this.btnCancel.Location = new Point(177, 354);
    ...
    this.btnAdd.Location = new Point(79, 354);
    ...
    this.ClientSize = new Size(346, 396);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDCauHinhTaiKhoan);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDCauHinhTaiKhoan_Load);
