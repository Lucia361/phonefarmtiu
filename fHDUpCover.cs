...
public class fHDUpCover : Form
{
  ...
  public fHDUpCover(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDUpCover.bool_0 = false;
    this.string_0 = string_3;
    this.string_2 = string_4;
    this.int_0 = int_1;
    string string_1_1 = "HDUpCover";
    string str = "Up cover";
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDUpCover));
    ...
    this.panel1.Size = new Size(362, 180);
    ...
    this.ckbXoaAnhDaDung.TabIndex = 36;
    ...
    this.btnCancel.Location = new Point(189, 136);
    ...
    this.btnAdd.Location = new Point(82, 136);
    ...
    this.ClientSize = new Size(362, 180);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDUpCover);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDUpCover_Load);
