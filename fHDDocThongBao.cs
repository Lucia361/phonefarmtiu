...
public class fHDDocThongBao : Form
{
  ...
  public fHDDocThongBao(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDDocThongBao");
  ...
  private void InitializeComponent()
  {
    ...
    this.panel1.Size = new Size(362, 197);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.nudDelayTo.Location = new Point(216, 109);
    ...
    this.nudSoLuongTo.Location = new Point(216, 80);
    ...
    this.nudDelayFrom.Location = new Point(122, 109);
    ...
    this.nudSoLuongFrom.Location = new Point(122, 80);
    ...
    this.txtTenHanhDong.Location = new Point(122, 49);
    this.txtTenHanhDong.Name = "txtTenHanhDong";
    this.txtTenHanhDong.Size = new Size(222, 23);
    this.txtTenHanhDong.TabIndex = 0;
    this.label7.Location = new Point(182, 111);
    this.label7.Name = "label7";
    this.label7.Size = new Size(29, 16);
    this.label7.TabIndex = 38;
    this.label7.Text = "đến";
    this.label7.TextAlign = ContentAlignment.MiddleCenter;
    this.label3.Location = new Point(182, 82);
    ...
    this.btnCancel.Location = new Point(190, 153);
    ...
    this.btnAdd.Location = new Point(86, 153);
    ...
    this.ClientSize = new Size(362, 197);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDDocThongBao);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDDocThongBao_Load);
