...
public class fNhapCookieTrungGian : Form
{
  ...
  public fNhapCookieTrungGian()
  {
    ...
    fNhapCookieTrungGian.bool_0 = false;
  }
  ...
  {
    GClass33.smethod_0("configGeneral").method_6("cookie", (object) this.txtCookie.Text);
    GClass33.smethod_2("configGeneral");
    fNhapCookieTrungGian.bool_0 = true;
    this.Close();
  }

  private void btnCancel_Click(object sender, EventArgs e) => this.Close();

  private void fNhapCookieTrungGian_Load(object sender, EventArgs e) => this.txtCookie.Text = GClass33.smethod_0("configGeneral").method_1("cookie");

  private void btnCheckLiveTokenTg_Click(object sender, EventArgs e)
  {
    if (Class38.smethod_4(this.txtCookie.Text, "", "", 0).StartsWith("1|"))
      GClass14.smethod_0((object) "Cookie live!");
    else
      GClass14.smethod_0((object) "Cookie die!");
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.txtCookie.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.txtCookie.Location = new Point(147, 58);
    this.txtCookie.Name = "txtCookie";
    this.txtCookie.Size = new Size(196, 23);
    ...
    this.Controls.Add((Control) this.txtCookie);
    this.Controls.Add((Control) this.btnCheckLiveTokenTg);
    this.Controls.Add((Control) this.btnCancel);
    this.Controls.Add((Control) this.btnAdd);
    this.Controls.Add((Control) this.bunifuCards1);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Name = nameof (fNhapCookieTrungGian);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "fAddFile";
    this.Load += new EventHandler(this.fNhapCookieTrungGian_Load);
