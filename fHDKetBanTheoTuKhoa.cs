...
public class fHDKetBanTheoTuKhoa : Form
{
  ...
  private NumericUpDown nudSoLuongKetBanMoiTuKhoaTo;
  private IContainer components;
  private NumericUpDown nudSoLuongKetBanMoiTuKhoaFrom;

  public fHDKetBanTheoTuKhoa(string string_3, int int_1 = 0, string string_4 = "")
  {
    this.InitializeComponent();
    fHDKetBanTheoTuKhoa.bool_0 = false;
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDKetBanTheoTuKhoa");
  ...
  private void fHDKetBanTheoTuKhoa_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.nudSoLuongKetBanMoiTuKhoaFrom.Value = (Decimal) this.gclass22_0.method_3("nudSoLuongKetBanMoiTuKhoaFrom", 1);
      this.nudSoLuongKetBanMoiTuKhoaTo.Value = (Decimal) this.gclass22_0.method_3("nudSoLuongKetBanMoiTuKhoaTo", 2);
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else if (GClass19.smethod_39(((IEnumerable<string>) this.txtTuKhoa.Lines).ToList<string>()).Count == 0)
    {
      GClass14.smethod_0((object) GClass35.smethod_0("Vui lòng nhập từ khóa!"), 3);
    }
    else
    {
      ...
      gclass22.method_6("nudSoLuongKetBanMoiTuKhoaFrom", (object) this.nudSoLuongKetBanMoiTuKhoaFrom.Value);
      gclass22.method_6("nudSoLuongKetBanMoiTuKhoaTo", (object) this.nudSoLuongKetBanMoiTuKhoaTo.Value);
      ...
      if (this.int_0 == 0)
      {
        ...
        {
          fHDKetBanTheoTuKhoa.bool_0 = true;
          this.Close();
        }
        else
  ...
  private void txtTuKhoa_TextChanged(object sender, EventArgs e) => GClass19.smethod_5(this.txtTuKhoa, (Control) this.lblStatus);

  private void groupBox1_Enter(object sender, EventArgs e)
  {
  }

  private void nudSoLuongFrom_ValueChanged(object sender, EventArgs e)
  {
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDKetBanTheoTuKhoa));
    ...
    this.nudSoLuongKetBanMoiTuKhoaTo = new NumericUpDown();
    this.nudSoLuongKetBanMoiTuKhoaFrom = new NumericUpDown();
    ...
    this.nudSoLuongKetBanMoiTuKhoaTo.BeginInit();
    this.nudSoLuongKetBanMoiTuKhoaFrom.BeginInit();
    ...
    this.panel1.Size = new Size(362, 433);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.groupBox1.Controls.Add((Control) this.txtTuKhoa);
    ...
    this.groupBox1.Controls.Add((Control) this.nudSoLuongKetBanMoiTuKhoaTo);
    this.groupBox1.Controls.Add((Control) this.nudSoLuongKetBanMoiTuKhoaFrom);
    this.groupBox1.Location = new Point(30, 140);
    this.groupBox1.Name = "groupBox1";
    this.groupBox1.Size = new Size(295, 236);
    this.groupBox1.TabIndex = 47;
    this.groupBox1.TabStop = false;
    this.groupBox1.Text = "Cấu hình từ khóa";
    this.groupBox1.Enter += new EventHandler(this.groupBox1_Enter);
    this.txtTuKhoa.Location = new Point(10, 39);
    this.txtTuKhoa.Name = "txtTuKhoa";
    this.txtTuKhoa.Size = new Size(279, 140);
    this.txtTuKhoa.TabIndex = 1;
    this.txtTuKhoa.Text = "";
    this.txtTuKhoa.TextChanged += new EventHandler(this.txtTuKhoa_TextChanged);
    this.lblStatus.AutoSize = true;
    this.lblStatus.Location = new Point(6, 19);
    ...
    this.label8.Size = new Size(259, 16);
    this.label8.TabIndex = 0;
    this.label8.Text = "(Mỗi từ khóa 1 dòng, spin nội dung {a|b|c})";
    this.label9.AutoSize = true;
    this.label9.Location = new Point(7, 208);
    this.label9.Name = "label9";
    this.label9.Size = new Size(128, 16);
    this.label9.TabIndex = 32;
    this.label9.Text = "Số lượng kb/từ khóa:";
    this.label10.AutoSize = true;
    this.label10.Location = new Point(260, 208);
    this.label10.Name = "label10";
    this.label10.Size = new Size(28, 16);
    this.label10.TabIndex = 35;
    this.label10.Text = "bạn";
    this.label11.Font = new Font("Tahoma", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
    this.label11.Location = new Point(183, 208);
    this.label11.Name = "label11";
    this.label11.Size = new Size(29, 16);
    this.label11.TabIndex = 37;
    this.label11.Text = ">";
    this.label11.TextAlign = ContentAlignment.MiddleCenter;
    this.nudSoLuongKetBanMoiTuKhoaTo.Location = new Point(218, 206);
    this.nudSoLuongKetBanMoiTuKhoaTo.Maximum = new Decimal(new int[4]
    {
      999999,
      0,
      0,
    ...
    this.nudSoLuongKetBanMoiTuKhoaTo.Name = "nudSoLuongKetBanMoiTuKhoaTo";
    this.nudSoLuongKetBanMoiTuKhoaTo.Size = new Size(40, 23);
    this.nudSoLuongKetBanMoiTuKhoaTo.TabIndex = 2;
    this.nudSoLuongKetBanMoiTuKhoaFrom.Location = new Point(137, 206);
    this.nudSoLuongKetBanMoiTuKhoaFrom.Maximum = new Decimal(new int[4]
    {
      999999,
      0,
      0,
    ...
    this.nudSoLuongKetBanMoiTuKhoaFrom.Name = "nudSoLuongKetBanMoiTuKhoaFrom";
    this.nudSoLuongKetBanMoiTuKhoaFrom.Size = new Size(40, 23);
    this.nudSoLuongKetBanMoiTuKhoaFrom.TabIndex = 1;
    ...
    this.nudSoLuongFrom.ValueChanged += new EventHandler(this.nudSoLuongFrom_ValueChanged);
    ...
    this.btnCancel.Location = new Point(185, 391);
    ...
    this.btnAdd.Location = new Point(78, 391);
    ...
    this.ClientSize = new Size(362, 433);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDKetBanTheoTuKhoa);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDKetBanTheoTuKhoa_Load);
    this.pnlHeader.ResumeLayout(false);
    this.panel1.ResumeLayout(false);
    this.panel1.PerformLayout();
    this.groupBox1.ResumeLayout(false);
    this.groupBox1.PerformLayout();
    this.nudSoLuongKetBanMoiTuKhoaTo.EndInit();
    this.nudSoLuongKetBanMoiTuKhoaFrom.EndInit();
