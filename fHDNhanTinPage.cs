...
public class fHDNhanTinPage : Form
{
  ...
  public fHDNhanTinPage(string string_3, int int_1 = 0, string string_4 = "")
  {
    ...
    {
      case 0:
        DataTable dataTable1 = Class205.smethod_13(string_1: "HDNhanTinPage");
  ...
  private void method_0()
  {
    ...
    GClass35.smethod_1((Control) this.lblStatusPage);
  ...
  private void fHDNhanTinPage_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.txtIdPage.Text = this.jobject_0["txtIdPage"].ToString();
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    else if (GClass19.smethod_39(((IEnumerable<string>) this.txtIdPage.Lines).ToList<string>()).Count == 0)
  ...
  private void txtIdPage_TextChanged(object sender, EventArgs e)
  {
    try
    {
      List<string> stringList = GClass19.smethod_39(((IEnumerable<string>) this.txtIdPage.Lines).ToList<string>());
      this.lblStatusPage.Text = string.Format(GClass35.smethod_0("Danh sách ID Page ({0}):"), (object) stringList.Count.ToString());
    }
    catch
    {
    }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (fHDNhanTinPage));
    ...
    this.panel1.Controls.Add((Control) this.lblStatusPage);
    ...
    this.panel1.Size = new Size(362, 500);
    this.panel1.TabIndex = 0;
    this.panel1.Paint += new PaintEventHandler(this.panel1_Paint);
    this.txtIdPage.Location = new Point(32, 161);
    this.txtIdPage.Multiline = true;
    this.txtIdPage.Name = "txtIdPage";
    this.txtIdPage.ScrollBars = ScrollBars.Both;
    this.txtIdPage.Size = new Size(295, 98);
    this.txtIdPage.TabIndex = 5;
    this.txtIdPage.WordWrap = false;
    this.txtIdPage.TextChanged += new EventHandler(this.txtIdPage_TextChanged);
    this.txtTinNhan.Location = new Point(31, 286);
    this.txtTinNhan.Multiline = true;
    this.txtTinNhan.Name = "txtTinNhan";
    this.txtTinNhan.ScrollBars = ScrollBars.Both;
    this.txtTinNhan.Size = new Size(295, 138);
    ...
    this.label8.Location = new Point(28, 427);
    ...
    this.lblStatusPage.Location = new Point(28, 139);
    this.lblStatusPage.Name = "lblStatusPage";
    this.lblStatusPage.Size = new Size(140, 16);
    this.lblStatusPage.TabIndex = 0;
    this.lblStatusPage.Text = "Danh sách ID Page (0):";
    this.lblStatus.AutoSize = true;
    this.lblStatus.Location = new Point(27, 264);
    ...
    this.label2.Size = new Size(95, 16);
    ...
    this.btnCancel.Location = new Point(185, 456);
    ...
    this.btnAdd.Location = new Point(78, 456);
    ...
    this.ClientSize = new Size(362, 500);
    this.Controls.Add((Control) this.panel1);
    this.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.FormBorderStyle = FormBorderStyle.None;
    this.Margin = new Padding(3, 4, 3, 4);
    this.Name = nameof (fHDNhanTinPage);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Cấu hình tương tác";
    this.Load += new EventHandler(this.fHDNhanTinPage_Load);
